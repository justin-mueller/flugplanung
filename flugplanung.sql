...
CREATE TABLE `mitglieder` (
  ...
  `fluggeraet` CHAR(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'G' COMMENT 'G = Gleitschirm, D = Drachen, S = Sonstiges, nur ein Zeichen erlaubt',
  `windenfahrer` tinyint(1) NOT NULL,
